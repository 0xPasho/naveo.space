...
export default function OutputGalleryDemo({ props }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {isRevealed ? (
        <div className="rounded-lg border border-[color:var(--brand-gold)]/30 bg-[color:var(--brand-gold)]/5 p-3 backdrop-blur">
          <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[color:var(--brand-gold)]">
