...
const colorClass = {
  vega: {
    ...
    glow: "shadow-[0_0_60px_-12px_var(--char-vega)]",
  ...
  atlas: {
    ...
    glow: "shadow-[0_0_60px_-12px_var(--char-atlas)]",
  ...
  echo: {
    ...
    glow: "shadow-[0_0_60px_-12px_var(--char-echo)]",
  ...
  forge: {
    ...
    glow: "shadow-[0_0_60px_-12px_var(--char-forge)]",
    ...
    <section className="overflow-hidden rounded-lg border border-white/10 bg-background/85 shadow-2xl shadow-black/20">
      ...
      <div className="flex flex-col items-center justify-center gap-6 bg-black/20 px-6 py-10 text-center">
        ...
        >
          <div
            className={cn(
              "flex size-32 items-center justify-center overflow-hidden rounded-2xl border-2",
              tint.border,
              tint.bg,
            )}
          >
            <img
              src={`/cast/${signer.slug}.svg`}
              alt={signer.name}
              className="h-full w-auto drop-shadow-[0_6px_18px_rgb(0_0_0/0.55)]"
            />
          </div>
