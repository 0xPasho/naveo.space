...
// Per-character signature colors. Source: --char-{slug} tokens in
// globals.css. Each crew member owns one accent — don't reassign.
const VEGA_GOLD = "var(--char-vega)"
const ECHO_CYAN = "var(--char-echo)"
const FORGE_ORANGE = "var(--char-forge)"
const ATLAS_BRONZE = "var(--char-atlas)"
...
export const TRACK_DISPLAY_META: Record<string, TrackMeta> = {
  "anatomia-del-prompt": {
    ...
    boss: false,
    crew: [
      { name: "Vega", mascot: "vega", color: VEGA_GOLD },
...
const DEFAULT_BY_ORDER: TrackMeta[] = [
  {
    ...
    duration: "—",
    boss: false,
    crew: [{ name: "Vega", mascot: "vega", color: VEGA_GOLD }],
  },
  {
    mascot: "echo",
    rank: "QUARTERMASTER",
  ...
  },
  {
    ...
    duration: "—",
    boss: true,
    crew: [{ name: "Atlas", mascot: "atlas", color: ATLAS_BRONZE }],
  },
]
