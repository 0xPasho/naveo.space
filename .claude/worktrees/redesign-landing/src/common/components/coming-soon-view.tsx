...
> = {
  practice: { mascot: "echo", ribbon: "var(--signal-cyan)" },
  crew: { mascot: "vega", ribbon: "var(--brand-gold)" },
  leaderboard: { mascot: "atlas", ribbon: "var(--mission-magenta)" },
  shop: { mascot: "vega", ribbon: "var(--plasma-violet)" },
}
